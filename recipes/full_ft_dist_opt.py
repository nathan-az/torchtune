...
class FullFinetuneRecipeDistributed(FTRecipeInterface):
    ...
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self.reshard_after_backward = cfg.get("fsdp_reshard_after_backward", True)
        self.delay_all_reduce = cfg.get("fsdp_delay_all_reduce", False)
        self.delay_gradient_sync = cfg.get("fsdp_delay_gradient_sync", False)
    ...
    def train(self) -> None:
        ...
        for curr_epoch in range(self.epochs_run, self.total_epochs):
            ...
            self._model.set_reshard_after_backward(self.reshard_after_backward)
